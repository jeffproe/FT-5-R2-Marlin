...
#define STRING_CONFIG_H_AUTHOR "(Jeff P, Folgertech FT5-R2)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "FT5R2-Marlin 2"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.67 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS / 2), 20 } // park in the middle of Y
